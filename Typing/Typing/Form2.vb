...
Public Class Form2
    ...
    Dim seconds As Integer = 60                      'number of seconds passed so far
        ...
        Select Case e.KeyValue
            Case Keys.Space
                ...
                ElseIf TextBox1.Text = " " Then
                    RichTextBox1.Text = words_array(i)
                    wrong += 1
                    ' i is unchanged if only space is pressed
                Else
                    RichTextBox1.Text = words_array(i)
                    wrong += 1
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        seconds -= 1            'interval is set to 1000 miliseconds, so decrease seconds each time after 1 second interval 
        sec += 1
        speed = correct_words * 60 / sec        'store speed 
        Label_correctwords.Text = correct_words     'this will show number of correct words to user
        Label_speed1.Text = speed
        If seconds = 0 Then                        'time limit set to this much seconds
            ...
            accuracy = (correct_words - wrong) / i * 100
